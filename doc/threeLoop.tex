...
\begin{center}
\begin{picture}(7,2)
\put(-0.5,2){\includegraphics[angle=270,width=0.48\textwidth]{mScanAs.eps}}
\put(1.83,2){\includegraphics[angle=270,width=0.48\textwidth]{tbScanDy.eps}}
\put(4.16,2){\includegraphics[angle=270,width=0.48\textwidth]{tbScanDyt.eps}}
\put(0,1.9){(a)}
\put(2.33,1.9){(b)}
\put(4.66,1.9){(c)}
\end{picture}
...
\begin{center}
\begin{picture}(6,7.8)
  \put(-0.75,2.8){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanYpAll}}
  \put(-0.75,5.5){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanYbAll}}
  \put(2.4,2.8){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanYpNone}}
\put(2.4,5.5){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanYbNone}}
  \put(-0.75,8.2){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanDaNone}}
  \put(0.08,7.64){\includegraphics[angle=270,width=0.45\textwidth]{atlasExcl}}
  \put(2.4,8.2){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanDaAll}}
...
\begin{center}
\begin{picture}(3,3)
  \put(-0.75,2.8){\includegraphics[angle=270,width=0.7\textwidth]{atlasScanDs}}
  \put(0.08,2.24){\includegraphics[angle=270,width=0.45\textwidth]{atlasExcl}}
\end{picture}
\end{center}
