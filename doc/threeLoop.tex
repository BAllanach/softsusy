...
All minimal supersymmetric quantities are extended to have three-loop
  renormalisation group equations in the dominant third family limit, 
  and leading two-loop threshold
  corrections are incorporated to the third family Yukawa couplings and the
...
The recent discovery of the Higgs~\cite{Aad:2012tfa,Chatyrchan:2012ufa} and
the measurement of its mass at around 
125-126 GeV solidify the important and well-known question of how its mass is
...
central value, once theoretical uncertainties have been taken into account.
