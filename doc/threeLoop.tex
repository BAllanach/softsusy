...
-0.2\\ \hline
%
quantity & $g_3(M_{SUSY})$ & $Y_t(M_{SUSY})$ & $Y_b(M_{SUSY})$ & $Y_\tau(M_{SUSY})$ & $\mu(M_{SUSY})$    &&\\
value &  1.036  & 0.836 & 0.128              &  0.097&2536 &&\\
$\Delta$/$\%$
& -1.0 & -1.9 & -1.8          &  -0.2&-0.002 &&\\
\hline
\end{tabular}
\end{center}
\caption{\label{tab:pmssm} Differences due to the highest order terms
  ...
  $\Delta$ shows the relative change due to the highest order terms.}
\end{table}
