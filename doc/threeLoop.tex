...
the prediction of the lightest CP even Higgs mass, there are various
contributions from Standard 
Model and supersymmetric particles. If we consider an internal loop with
a stop propagator, which mass do we use for the stop? One achieves
