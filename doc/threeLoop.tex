...
\caption{\label{tab:cmssm} Differences due to the highest order terms
  ...
  in the focus point of the CMSSM for $m_0=7200$ GeV, $M_{1/2}=800$ GeV,
...
($m_0=7200$ GeV, $M_{1/2}=800$ GeV, $A_0=-6000$ GeV,
...
row of Table~\ref{tab:cmssm}, one may use the command
{\small\begin{verbatim}
./softpoint.x sugra --m0=7200 --m12=800 --a0=-6000 --tanBeta=50 --sgnMu=1 --mt=173.2 --alpha_s=0.1187 
--twoloop-susy-thresholds --three-loop-rges
\end{verbatim}\normalsize}
with {\tt SOFTSUSY3.5.0}.
For the calculation
