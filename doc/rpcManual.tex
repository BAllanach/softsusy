...
\put(10,0){\makebox(280,10)[c]{\fbox{Calculate Higgs and
      sparticle pole masses. Run to $M_{QED \times QCD}$.}}}
%\put(150,36.5){\vector(0,-1){23}}
\put(10,40){\makebox(280,10)[c]{\fbox{Run to $M_{QED \times QCD}$.}}}
...
$g_i(M_{QED \times QCD})$, $h_{t,b,\tau}(M_{QED \times QCD})$.}}}
...
\end{equation}
%where $L\equiv \ln ({m_t^2(M_{QED \times QCD})^{\overline{DR}}_{MSSM}} / M_{QED \times QCD}^2)$.
