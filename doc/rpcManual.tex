...
m_b(M_Z)^{\overline{MS}}_{SM} \left(1 - \frac{{\alpha_s}^{\overline{MS}}_{SM}}{3 \pi}
- \frac{29 
  {({\alpha_s}^{\overline{MS}}_{SM}})^2}{72 \pi^2} + 
\frac{3 g^2}{128 \pi^2} + \frac{13 g_1^2}{1152 \pi^2} \right),
\end{equation}
where in this equation, ${\alpha_s}^{\overline{MS}}_{SM}$ is evaluated at a
renormalisation scale $N_f$ in the 5 flavour Standard Model at $M_Z$.
