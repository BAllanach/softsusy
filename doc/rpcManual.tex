...
The Higgs VEV parameter $v(M_{SUSY})$ is set by:
\begin{equation}
v^2(M_{SUSY}) = 4 \frac{M_Z^2 + \Re\Pi_{ZZ}^T(M_{SUSY})}{g_2^2(M_{SUSY}) + 3 g_1^2(M_{SUSY}) / 5},
\end{equation}
where
...
converges to a given accuracy. $m_3(M_{SUSY})$ is then determined by input the value
