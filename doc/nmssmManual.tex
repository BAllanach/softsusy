...
\ea where $\bar g = \sqrt{g^2+g^{\prime 2}}$ and $g$ and $g^{\prime}$
...
The chargino, gluino and sfermion masses are given by the same expressions as in the MSSM with $\mu \rightarrow \mu_\textrm{eff}$. 
