...
when comparing against {\tt SARAH} and {\tt FlexibleSUSY}. We thank Ben Farmer for providing some feedback after using a pre-release verion of the code.
PA and AV also thank Dominik St\"ockinger for many helpful
...
offering helpful remarks. PA would also like to thank Roman Nevzorov for useful discussions.  LCT is supported by the Federal Commission for Scholarships for Foreign Students.
