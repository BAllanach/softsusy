...
\ba 
 W^{general}_{NMSSM} &=&\hat{u}^c \, \mathbf{y_u} \hat{Q} \hat{H}_u 
-\hat{d}^c \, \mathbf{y_d} \hat{Q} \hat{H}_d 
-\hat{e}^c \, \mathbf{y_e} \hat{L} \hat{H}_d 
...
\ba 
 W_{NMSSM} &=& \hat{u}^c \, \mathbf{y_u} \hat{Q} \hat{H}_u 
-\hat{d}^c \, \mathbf{y_d} \hat{Q} \hat{H}_d 
-\hat{e}^c \, \mathbf{y_e} \hat{L} \hat{H}_d 
