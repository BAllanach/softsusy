...
(\ref{eq:WZ3V}). In Table~\ref{tab:conv} we provide a comparison of the 
...
\cite{Degrassi:2009yq}, while deleting the first row from $P$ produces the 2 by
 3 mixing matrix for the physical CP-odd Higgs bosons in SLHA2 conventions \cite{Allanach:2008qq}. Following the review of Ellwanger, Hugonie and Teixeira (EHT)
 \cite{Ellwanger:2009dp}, the entries of the 3 by 3 mass matrix 
$ M^{\prime \, 2}_{P}$ in the $H^I$ basis read
%
\ba
...
Sperling et al.\ \cite{Sper13,Sper13-2}, where the pure   NMSSM contributions are 
...
changed, see \code{softpoin.x --help}.  For the MSSM the new syntax is
%
\small
\begin{verbatim}
