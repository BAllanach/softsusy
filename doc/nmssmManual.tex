...
\noindent The $Z_3$ NMSSM superpotential contains no explicit mass parameter, thereby solving the $\mu$-problem.   As such it is sometimes refered to as the scale invariant NMSSM in the literature.  Here we will always write $Z_3$-NMSSM when for the $Z_3$ conserving case and \Zv-NMSSM for the general $Z_3$ violating one. 
