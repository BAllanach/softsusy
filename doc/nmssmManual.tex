...
Appendix~\ref{sec:run}, we state how to run the program. The class structure,
along with the data contained within each class, is shown in
Appendix~\ref{sec:objects}. Finally, in Appendix~\ref{sec:RGEs}, we reproduce
...
\noindent where the subscript \Zv~reflects the fact that this superpotential contains terms which violate the $\mathbb{Z}_3$ symmetry which is commonly imposed on the 
NMSSM.  Imposing the $\mathbb{Z}_3$ symmetry restricts the superpotential to
%
\begin{align} 
...
\end{align}
%
\noindent The $\mathbb{Z}_3$-NMSSM superpotential (\ref{eq:WZ3C}) contains no explicit 
...
write $\mathbb{Z}_3$-NMSSM for the $\mathbb{Z}_3$ conserving case and \Zv-NMSSM for the general 
$\mathbb{Z}_3$ violating one. 
