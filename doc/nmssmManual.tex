...
entry $15$ set to $1$.  \code{slhaOutput} is the name of the SLHA
output file which will contain the spectrum and the decays.
Additional NMSSMTools specific flags can also be used with entries
$16$ and $17$.
%
\begin{verbatim}
   Block SOFTSUSY
      15   1      # NMSSMTools compatible output (default: 0) 
      16   4      # Micromegas options for use with NMSSMTools
                  # (default: 0) 0=no, 1=relic density only
                  # 2=direct detection, 3=indirect detection
                  # 4=both  
