...
\begin{figure}
\begin{center}
%\includegraphics[width=350pt]{nmssmalg}
...
\begin{figure}
  \begin{center}
%\includegraphics[width=345pt]{nmssmobj}
...
\BText(60,180){{\tt RGE}}
\BText(150,190){{\tt NmssmSusyRGE}}
\BText(20,130){{\tt QedQcd}}
\BText(150,160){{\tt MssmSusy}}
\BText(150,100){{\tt SoftParsMssm}}
\BText(150,130){{\tt MssmSoftsusy}}
\BText(250,190){{\tt NmssmSusyPars}}
\BText(250,160){{\tt NmssmSoftsusy}}
\BText(250,130){{\tt SoftParsNmssm}}
 \end{picture}
\end{center}
