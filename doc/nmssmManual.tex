...
\ba m_{H_1}^2&=& \frac{1}{8} {\bar g}^2 (v_2^2-v_1^2) - \ds\frac{1}{2}\lambda^2 v_2^2
 + (m_3^2)_\textrm{eff} \frac{v_2}{v_1} 
- |\mu_\textrm{eff}|^2, \label{eq:mind}\\
m_{H_2}^2&=& \frac{1}{8} {\bar g}^2 (v_1^2-v_2^2) - \ds\frac{1}{2}\lambda^2 v_1^2 
+ (m_3^2)_\textrm{eff} \frac{v_1}{v_2} 
...
where $\bar g = \sqrt{g^2+g^{\prime 2}}$ and $g$ and $g^{\prime}$
are the gauge couplings of $SU(2)_L$ and $U(1)$ interactions
respectively, with $g = g_2$ and $g^\prime = \sqrt{3/5} \, g_1$. For simplicity we have introduced,
...
The chargino, gluino and sfermion masses are given by the same expressions as in the MSSM with \be\mu \rightarrow \mu_\textrm{eff} = \mu + \lambda \frac{s}{\sqrt{2}} \;\;\; {\rm where } \;\;\;\; \langle S \rangle = \frac{s}{\sqrt{2}} \ee with $\mu = 0$ in the $Z_3$-NMSSM. 
...
\ba
 (M_{H^0}^2)_{11} & = & \frac{1}{2}g^2 v_1^2 + (\mu_\textrm{eff}\, B_\textrm{eff} +
\widehat{m}_3^2)\,\tan\beta\;, \nn\\
 (M_{H^0}^2)_{22} & = & \frac{1}{2} g^2 v_2^2 + (\mu_\textrm{eff}\, B_\textrm{eff} +
\widehat{m}_3^2)/\tan\beta\;, \nn\\
...
+ \frac{\kappa s}{\sqrt{2}} (A_\kappa + 4\frac{\kappa s}{\sqrt{2}}+ 3 \mu') - \sqrt{2}(\xi_S + \xi_F \mu')/s\;, \nn\\
 (M_{H^0}^2)_{12} & = & (2\lambda^2 - g^2) \frac{v_2 v_1 }{2}- 
\mu_\textrm{eff}\, B_\textrm{eff} - \widehat{m}_3^2 \;, \nn\\ 
