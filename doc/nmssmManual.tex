...
include a test at $M_{\rm SUSY}$ to determine whether the chosen parameter
space  
...
when comparing against {\tt SARAH} and {\tt FlexibleSUSY}. We thank Ben Farmer
for providing some feedback after using a pre-release verion of the code. 
