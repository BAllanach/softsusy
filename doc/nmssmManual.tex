...
\begin{abstract}
  ...
  the minimal supersymmetric standard model fields. Often, a $Z_3$ symmetry is
  imposed upon the model. \SOFTSUSY~can calculate the spectrum in this
  case as well as the case where general $Z_3$ violating terms are added to
...
Higgs'. Currently, in the minimal supersymmetric standard model, there are
several spectrum generators: {\tt
...
In the minimal supersymmetric standard model the model can be natural if stops
are light, but stops must be heavy to get a heavy higgs. Cite Abdel too. But
