...
Model (SM) gauge couplings and the provision of a potential a
...
measurement~\cite{Delgado:2010uj,Ellwanger:2011mu,King:2012tr,Perelstein:2012qg}, 
one can augment the MSSM by a gauge singlet chiral
superfield~\cite{BasteroGil:2000bw,Ellwanger:2009dp}. This model is referred to as the 
Next-to-Minimal 
...
particle collisions in the NMSSM and, in addition, micrOMEGAs~\cite{Belanger:2008sj}
...
several publicly available and supported spectrum generators naturally also extends to the
case of the increasingly popular NMSSM.
The extension of {\tt SOFTSUSY} program to include the
...
\ref{sec:run}, we explain how to run the program. The class structure,
...
and by the Australian Research Council through its Centres of Excellence program. 
We thank Pietro
