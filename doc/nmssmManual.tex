...
pieces give a good approximation when not tto far away from the MSSM
limit and allow an easier comparisons against MSSM results.

The sfermions, neutralinos and charginos also recieve new NMSSM
...
and also autogenerated Latex output from SARAH showing these self
energies, as well as simple checks by deriving a few things ourselves.

Finally all one loop self energies, Tadpoles and two loop REGEs were unit tested against code pieces auto-generated from FLEXIBLE SUPERSYMMETRY \cite{flexi-susy}, an in development code which makes sure of the aforementioned SARAH package\cite{Staub:2009bi,Staub:2010jh,Staub:2012pb,Staub:2013tta}. 
...
when comparing against SARAH and FLEXIBLE SUPERSYMMTRY. PA and AV
...
\bibitem{flexi-susy} 
P.~Athron, Jae-hyeon Park, D.~Stockinger and A.~Voigt,\\
{\it Flexible Supersymmetry} \\
In Development \\
