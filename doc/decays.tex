...
%\multicolumn{2}{|C{3.0cm}|}{{\tt SOFTSUSY} no QCD corrections} & \multicolumn{2}{C{3.0cm}|}{{\tt SOFTSUSY} with QCD %corrections} & \multicolumn{2}{C{3.0cm}|}{SOFTSUSY with {\tt SUSYHIT}'s masses and QCD corrections} & \multicolumn{2}%{C{3.0cm}|}{{\tt HDECAY-3.4} with QCD corrections} & mode \\ \hline
%PW/GeV & BR & PW/GeV & BR & PW/GeV & BR & PW/GeV & BR & \\ \hline
%1.03e-04 & 3.36e-02 & 2.23e-04 & 3.99e-02 & 2.23e-04 & 4.56e-02 & 2.23e-04 & 4.35e-02 & $h \rightarrow c c$ \\ %\hline
%8.05e-07 & 2.62e-04 & 1.56e-06 & 2.80e-04 & 1.56e-06 & 3.20e-04 & 1.57e-06 & 3.06e-04 & $h \rightarrow s s$ \\ %\hline
%1.70e-03 & 5.54e-01 & 3.98e-03 & 7.13e-01 & 3.29e-03 & 6.74e-01 & 3.46e-03 & 6.76e-01 & $h \rightarrow b b$ \\ %\hline
%8.65e-07 & 2.82e-04 & 8.65e-07 & 1.55e-04 & 9.27e-07 & 1.90e-04 & 9.31e-07 & 1.82e-04 & $h \rightarrow \mu \mu$ \\ %\hline
%2.71e-04 & 8.83e-02 & 2.71e-04 & 4.86e-02 & 2.62e-04 & 5.36e-02 & 2.63e-04 & 5.14e-02 & $h \rightarrow \tau \tau$ \\ %\hline
%1.06e-05 & 3.46e-03 & 1.06e-05 & 1.90e-03 & 9.29e-06 & 1.90e-03 & 9.29e-06 & 1.81e-03 & $h \rightarrow \gamma %\gamma$ \\ \hline
%1.71e-04 & 5.57e-02 & 2.82e-04 & 5.04e-02 & 2.84e-04 & 5.82e-02 & 2.84e-04 & 5.55e-02 & $h \rightarrow g g$ \\ %\hline
%6.95e-06 & 2.26e-03 & 6.95e-06 & 1.25e-03 & 6.06e-06 & 1.24e-03 & 6.29e-06 & 1.23e-03 & $h \rightarrow Z \gamma$ \\ %\hline
%7.23e-04 & 2.36e-01 & 7.23e-04 & 1.30e-01 & 7.23e-04 & 1.48e-01 & 7.87e-04 & 1.54e-01 & $h \rightarrow W W^*$ \\ %\hline
%8.13e-05 & 2.65e-02 & 8.13e-05 & 1.46e-02 & 8.13e-05 & 1.66e-02 & 8.56e-05 & 1.67e-02 & $h \rightarrow Z Z^*$ \\ %\hline
%\end{tabular}
...
%    HDECAY}'s quark and gauge boson masses and gauge couplings and with QCD
...
%  {\tt SOFTSUSY} and {\tt HDECAY-3.4}. This is for a CMSSM point 
...
Figure~\ref{h0scancomp} shows how the branching ratios of an SM-like Higgs change as its
...
\begin{figure}
  ...
  \caption{Branching ratios for an SM(-like) Higgs as calculated in (a) by {\tt SOFTSUSY} and in (b) by the LHC Higgs Cross-Section Working Group in \cite{Denner:2011}. This demonstrates a verification of the partial widths output by {\tt SOFTSUSY}.} \label{h0scancomp}
\end{figure} 
...
\end{tabular}
\caption{The $\tilde{g}$ decay partial widths and branching ratios to $\tilde{Z}_i b \bar{b}$ as output by {\tt SOFTSUSY} with \code{runmb} taken so that the $b$ Yukawa coupling in {\tt SOFTSUSY} matches that in {\tt sPHENO}. These decays showed significant differences between the two programs, particularly for $\tilde{Z}_3$ and $\tilde{Z}_4$, see Table~\ref{gluino3bodycomp}. The agreement is now much improved, demonstrating that the differences result from a choice of the running $b$ mass \code{runmb} and hence in the Yukawa coupling. This again used the parameters from {\tt sPHENO}'s spectrum file directly in the {\tt SOFTSUSY} decay calculator, with the addition relative to Table~\ref{gluino3bodycomp} of {\tt sPHENO}'s running $b$ mass.}
...
\subsection{NMSSM Decays - $H_3$}

Similar detailed checks to those above were performed in the NMSSM fields'
sector and 
we provide some 
details here. For example, in Table~\ref{nmssmSLHAnoZ3Inputspctable} we
present a quantitative comparison of the decays of the heaviest neutral CP
even Higgs of the NMSSM, the $H3$, for the parameter space point {\tt nmssmSLHAnoZ3Input} provided with
the {\tt SOFTSUSY} package. The spectrum is given in
Figure~\ref{nmssmSLHAnoZ3Inputspectrum} with decay modes of branching ratios
(BRs) greater than $10^{-6}$ indicated by arrows, with thicker, bolder arrows
representing larger BRs. It should be noted that for this parameter point it
is actually the second heaviest of the CP even neutral Higgs bosons which
is most NMSSM singlet-like, meanwhile the $\tilde{Z}_3$ is dominantly the singlino.
Decays involving the $H$ and $\tilde{Z}_3$ here are therefore most specific to 
the NMSSM\@. Validation was of course carried out for all the particle decays of
the extended Higgs and Neutralino sectors, we just provide that of the $H3$ here.
The comparison in Table~\ref{nmssmSLHAnoZ3Inputspctable} demonstrates that the level of
agreement is usually better than $10\%$ and generally around $5\%$ with the
exception of a few of the decay modes. The decay modes which show larger
differences are the decays to quarks, 1-loop decays and the decays to two
vector bosons. For the decays to quarks and the 1-loop decay to $gg$, there are differences in the value of $\alpha_s$ between {\tt SOFTSUSY} and {\tt NMSSMTools} which explain the
majority of the differences observed (with remaining small input differences
explaining the remaining difference). {\tt SOFTSUSY} and {\tt  NMSSMTools} both run the gauge couplings to the 
scale of the $H3$ however there are differences in the running order and scheme; {\tt SOFTSUSY} matches at $m_Z$ and then runs $\alpha_s$ in the full NMSSM at 2-loops with 1-loop threshold corrections at $m_Z$. Similarly for the case 
of the decay to $\gamma\gamma$ there are differences in the $\alpha$ values obtained by the two programs in running to $m_{H3}$, however now there are also further differences as {\tt SOFTSUSY} also runs the quark masses to $m_{H3}$ for the $\gamma\gamma$ case whereas {\tt NMSSMTools} does not. The exact values of the gauge couplings and quark 
masses in the two programs are given in the caption to Table~\ref{nmssmSLHAnoZ3Inputspctable}.
Significantly improved agreement is seen in
Table~\ref{nmssmSLHAnoZ3Inputspctable} when the {\tt NMSSMTools} values of
masses and 
coupling constants are taken within {\tt SOFTSUSY}, in this case the
disagreement between the programs is then back to less than $5\%$. In decays
to vector bosons the large differences observed (shown in bold) 
are a consequence of a delicate cancellation in the coupling at this parameter
point which means small input parameter differences result in large
differences in the coupling and so cause consequent large differences in the
output partial widths, which are proportional to the coupling squared. The
differences between the two programs here can therefore be interpreted as an
indication of a large theoretical error in the calculation at this parameter
point and at this level of accuracy. 
Note that the comparison is carried out
against an old version of {\tt NMSSMTools}: {\tt NMSSMTools-4.2.1} as there
exists a link code 
between the  
{\tt SOFTSUSY} spectrum generator and this version of {\tt NMSSMTools}, which does not work for later versions. Therefore comparing with {\tt NMSSMTools-4.2.1} allowed the effects of the spectrum
...
\caption{Mass spectrum and branching ratios for the NMSSM parameter point {\tt
    nmssmSLHAnoZ3Input} used for the comparison with {\tt NMSSMTools}. The
  arrows represent decay modes of branching ratios (BRs) greater than
  $10^{-6}$, with thicker, bolder arrows representing larger BRs. The full
  input file is provided with the {\tt SOFTSUSY-4.0} package, but it is a
  constrained NMSSM point with $m_0 =
  400$ GeV, $m_{1/2} = 100$ GeV, 
  $\tan\beta = 10$, sign$(\mu) = +1$, $A_0 = -300$ GeV, $\lambda = 0.1$,
  $\kappa = 
  0.1$, $\lambda \langle S \rangle = 100$ GeV and $\xi_F = 100$ GeV\@. 
%Note
%  that our notation $\tilde{Z}_i$ and $\tilde{W}_j$ are 
%  indicated 
%  as $\tilde{\chi}_{i}^{0}$ and $\tilde{\chi}_{j}^{\pm}$ respectively in this
%  figure. 
...
%\def\arraystretch{1.1}%
\begin{tabular}{|c|c|c|c|c|c|c|} \hline
\multicolumn{2}{|C{3.0cm}|}{{\tt SOFTSUSY} with its quark masses and coupling constants run to $m_{H3}$} & \multicolumn{2}{C{3.0cm}|}{{\tt SOFTSUSY} with {\tt NMSSMTools-4.2.1} quark masses and running coupling constants} & \multicolumn{2}{C{3.0cm}|}{{\tt NMSSMTools-4.2.1}} & mode \\ \hline
PW/GeV & BR & PW/GeV & BR & PW/GeV & BR & \\ \hline
8.46e-06 & 2.55e-06 & 8.88e-06 & 2.84e-06 & 9.01e-06 & 2.82e-06 & $H_{3} \rightarrow c \bar{c}$ \\ \hline
4.08e-04 & 1.23e-04 & 4.94e-04 & 1.58e-04 & 5.16e-04 & 1.62e-04 & $H_{3} \rightarrow s \bar{s}$ \\ \hline
1.24e+00 & 3.72e-01 & 1.04e+00 & 3.32e-01 & 1.09e+00 & 3.40e-01 & $H_{3} \rightarrow b \bar{b}$ \\ \hline
1.62e-01 & 4.88e-02 & 1.62e-01 & 5.18e-02 & 1.64e-01 & 5.14e-02 & $H_{3} \rightarrow t \bar{t}$ \\ \hline
3.39e-04 & 1.02e-04 & 3.58e-04 & 1.15e-04 & 3.75e-04 & 1.18e-04 & $H_{3} \rightarrow \mu^- \mu^+$ \\ \hline
1.03e-01 & 3.09e-02 & 1.01e-01 & 3.25e-02 & 1.06e-01 & 3.33e-02 & $H_{3} \rightarrow \tau^- \tau^+$ \\ \hline
3.74e-02 & 1.13e-02 & 3.74e-02 & 1.20e-02 & 3.55e-02 & 1.11e-02 & $H_{3} \rightarrow \tilde{Z}_1 \tilde{Z}_1$  \\ \hline
1.42e-01 & 4.27e-02 & 1.42e-01 & 4.54e-02 & 1.40e-01 & 4.38e-02 & $H_{3} \rightarrow \tilde{Z}_1 \tilde{Z}_2$ \\ \hline
2.34e-03 & 7.05e-04 & 2.34e-03 & 7.50e-04 & 2.35e-03 & 7.35e-04 & $H_{3} \rightarrow \tilde{Z}_1 \tilde{Z}_3$ \\ \hline
1.83e-01 & 5.51e-02 & 1.83e-01 & 5.86e-02 & 1.74e-01 & 5.45e-02 & $H_{3} \rightarrow \tilde{Z}_1 \tilde{Z}_4$ \\ \hline
1.22e-01 & 3.68e-02 & 1.22e-01 & 3.92e-02 & 1.26e-01 & 3.94e-02 & $H_{3} \rightarrow \tilde{Z}_2 \tilde{Z}_2$ \\ \hline
6.15e-03 & 1.85e-03 & 6.15e-03 & 1.97e-03 & 6.21e-03 & 1.95e-03 & $H_{3} \rightarrow \tilde{Z}_2 \tilde{Z}_3$ \\ \hline
2.81e-01 & 8.46e-02 & 2.81e-01 & 9.0e-02 & 2.89e-01 & 9.07e-02 & $H_{3} \rightarrow \tilde{Z}_2 \tilde{Z}_4$ \\ \hline
1.11e-04 & 3.35e-05 & 1.11e-04 & 3.56e-05 & 1.11e-04 & 3.48e-05 & $H_{3} \rightarrow \tilde{Z}_3 \tilde{Z}_3$ \\ \hline
3.63e-01 & 1.09e-01 & 3.63e-01 & 1.16e-01 & 3.62e-01 & 1.13e-01 & $H_{3} \rightarrow \tilde{W}_1 \tilde{W}_1$ \\ \hline
3.18e-01 & 9.58e-02 & 3.18e-01 & 1.02e-01 & 3.25e-01 & 1.02e-01 & $H_{3} \rightarrow \tilde{W}_1 \tilde{W}_2$ \\ \hline
3.18e-01 & 9.58e-02 & 3.18e-01 & 1.02e-01 & 3.25e-01 & 1.02e-01 & $H_{3} \rightarrow \tilde{W}_2 \tilde{W}_1$ \\ \hline
6.97e-03 & 2.10e-03 & 6.97e-03 & 2.23e-03 & 7.11e-03 & 2.23e-03 & $H_{3} \rightarrow h h$ \\ \hline
1.20e-05 & 3.63e-06 & 1.12e-05 & 3.58e-06 & 1.06e-05 & 3.31e-06 & $H_{3} \rightarrow \gamma \gamma$ \\ \hline
9.09e-04 & 2.74e-04 & 7.61e-04 & 2.44e-04 & 8.00e-04 & 2.51e-04 & $H_{3} \rightarrow g g$ \\ \hline
3.37e-05 & 1.02e-05 & 3.37e-05 & 1.08e-05 & 3.35e-05 & 1.05e-05 & $H_{3} \rightarrow Z \gamma$ \\ \hline
1.42e-03 & 4.26e-04 & \textbf{1.42e-03} & 4.53e-04 & \textbf{3.25e-03} & 1.02e-03 & $H_{3} \rightarrow W^+ W^-$ \\ \hline
6.79e-04 & 2.04e-04 & \textbf{6.79e-04} & 2.17e-04 & \textbf{1.56e-03} & 4.89e-04 & $H_{3} \rightarrow Z Z$ \\ \hline
2.79e-02 & 8.39e-03 & 2.79e-02 & 8.93e-03 & 2.61e-02 & 8.17e-03 & $H_{3} \rightarrow \tilde{Z}_1 \tilde{Z}_5$ \\ \hline
8.61e-03 & 2.59e-03 & 8.61e-03 & 2.76e-03 & 8.89e-03 & 2.79e-03 & $H_{3} \rightarrow \tilde{Z}_2 \tilde{Z}_5$ \\ \hline
4.84e-05 & 1.46e-05 & 4.84e-05 & 1.55e-05 & 5.06e-05 & 1.59e-05 & $H_{3} \rightarrow h H$ \\ \hline
3.32e+00 & 1.00e+00 & 3.12e+00 & 1.00e+00 & 3.19e+00 & 1.00e+00 & Column totals \\ \hline
\end{tabular}
\caption{The $H3$ decay partial widths and branching ratios as output by {\tt
    SOFTSUSY} with the quark masses and coupling constants run to $m_{H3}$
  as is the default, {\tt SOFTSUSY} with the quark masses and coupling
  ...
  4 this  
  meant setting $\alpha_s(m_{H3})= 9.42\times10^{-2}$, $m_b = 4.54$ GeV for
  $H3  
  \rightarrow 
  bb$, $m_{\mu}= 0.106$ GeV for $H3 \rightarrow \mu \mu$, $m_{\tau}=
  1.78$ GeV for $H3 
  \rightarrow  
  \tau \tau$, and the same values were used appropriately for $H3
  \rightarrow gg$. These should be compared with the values {\tt SOFTSUSY} obtains from
  running to the $H3$ mass of $\alpha_s(m_{H3}) = 9.70\times 10^{-2}$, $m_b(m_{H3}) = 4.97$GeV, 
  $m_{\mu} = 0.103$GeV, $m_{\tau} = 1.79$GeV. Meanwhile for $H3 \rightarrow \gamma \gamma$, {\tt SOFTSUSY}
  uses $m_t(m_{H3}) = 146.6$GeV, $m_{b}(m_{H3}) = 2.42$GeV, $m_c(m_{H3}) = 0.57$GeV whereas {\tt NMSSMTools}
  has $m_t = 170.9$GeV, $m_b = 4.54$GeV, $m_c = 1.40$GeV. These were therefore input into {\tt SOFTSUSY} 
  for columns 3 and 4. There is also a difference in $\alpha$, in {\tt SOFTSUSY} this is run to $m_{H3}$ giving 
  $\alpha(m_{H3}) = 7.91\times10^{-3}$ whereas {\tt NMSSMTools} obtains $\alpha(m_{H3}) = 7.30\times10^{-3}$. This
  is therefore also set in the decay calculator code for columns 3 and 4.
  The 
  parameter point considered is the {\tt nmssmSLHAnoZ3Input} file provided
  with the {\tt SOFTSUSY} package. There is good agreement between the two
  programs with differences around $5-10\%$. Differences can be larger for the
  decays to quarks and 1-loop decays to $\gamma \gamma$ and $gg$ due to
  differences in the quark masses and coupling constants taken. Using the same
  values for these as in {\tt NMSSMTools} significantly reduces these
  differences to around $5\%$ or less, demonstrating this is the main source
  of the differences. This is illustrated in the improved agreement of the 3rd
  and 4th columns with the 5th and 6th columns. A more detailed description of
...
{\centering
\begin{equation}
\tilde{\lambda}^{1/2} (m_{1}, m_2, m_{3}) = \sqrt{(1- ({m_2 + m_3 \over m_1})^2)(1-({m_2 - m_3 \over m_1})^2)}
\end{equation}
}
...
g(\tau) = \begin{cases} \label{gtau}
			...
			{1 \over 2}\sqrt{1-\tau} [\ln({1+\sqrt{1-\tau} \over 1-\sqrt{1-\tau}}) - i \pi], \: $for$ & \: \: \tau < 1 \\
			\end{cases}
\end{equation}
...
For this decay mode, and the ``reverse'' decay mode $\tilde{W}_j \rightarrow \tilde{Z}_i f' \bar{f}$, the formulae used are extracted from the {\tt sPHENO} code, based on the work in references \cite{Baer:1998, TataBaer}. Note that $f'$, $f$ are fermions with third components of weak isospin $1 \over 2$ and $-{1 \over 2}$ respectively. A difference relative to these references is that, following the formulae of {\tt sPHENO}, the expressions given do not neglect $m_f$ in the Dirac algebra of the squared matrix element (whereas in \cite{Baer:1998, TataBaer} it is neglected here, but of course included in the phase space). As a result there is also $WH^{\pm}$ interference which is not present if $m_f$ is neglected in the Dirac algebra. The possibilities of positive and negative neutralino and chargino masses are included via $(-1)^{\theta_{i}}$ and $(-1)^{\theta_{j}}$ factors. Similarly the fermion Yukawa couplings are included and the formulae themselves allow for mixing of the fermions. However in our program, mixing is only considered for the third generation of sfermions and here this 3 body mode $\tilde{Z}_i \rightarrow \tilde{W}_j t \bar{b}$ is not calculated as the 2 body modes $\tilde{Z}_i \rightarrow W \tilde{W}_j$ and $\tilde{Z}_i \rightarrow h \tilde{W}_j$ are then kinematically available and will dominate the branching ratios.
...
Only 2 body decays have been included in the NMSSM, this does however include the important loop decays of the neutral Higgs bosons to $\gamma\gamma$, $Z\gamma$ and $gg$, as well as QCD corrections to the neutral Higgs decays to $q\bar{q}$ and $gg$. We do however include the decays $\phi \rightarrow WW^* \rightarrow Wf'\bar{f}$ and $\phi \rightarrow ZZ^* \rightarrow Zf\bar{f}$.\footnote{The decays $\phi \rightarrow WW^* \rightarrow Wf'\bar{f}$ and $\phi \rightarrow ZZ^* \rightarrow Zf\bar{f}$, whilst strictly being 3 body, are classified as having NDA (Number of Daughters) of 2 according to SLHA conventions.}
...
\end{aligned}
\end{equation}
This is exactly as given in Eqs. (16) and (25) of \cite{Spira:2016}. $Li_2$ is the di-logarithm function, aka Spence's function. 
