...
--two-loop-sparticle-mass=<expandAroundGluinoPole>
\end{verbatim}\normalsize}
The variable \code{expandAroundGluinoPole}
expands the two-loop computation of the gluino mass around the
gluino and squark masses if it is set to \code{2}, around only the gluino mass
if set to \code{3} and performs no expansion if it is set to \code{1}.
