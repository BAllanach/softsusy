...
%
\hline&& $\Delta \alpha$ & $\Delta Y$ & $\Delta Y'$&$M_{GUT}/10^{16}$&&& \\ \hline None                   & 2 & -0.0004 & -0.133 & 0.168 & 1.665 & & & \\
$\Delta \alpha_s$  & 2 & -0.001 &  -0.124 & { 0.198} & -0.034 & & & \\
$\Delta m_t$  & 2 & N/A & N/A & N/A & N/A &  & &\\
$\Delta m_b,m_\tau$  & 2 & { -0.000} & { -0.133} & { 0.168} & 0.000 & & & \\
$\Delta$ All  & 3 & { -0.001} & { -0.109} & { 0.121} & 0.076 & & & \\
\hline
\end{tabular}
\end{center}
