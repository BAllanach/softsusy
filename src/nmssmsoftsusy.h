...
namespace softsusy {
  ...
  private:
    ...
    /// DH: stores achieved accuracy in Higgs diagonalisation
    double drbarHiggsAccuracy;
    double physHiggsAccuracy;
    ...
    struct FineTuningPars {
      ...
      FineTuningPars()
        : model(0), ftFunctionality(0),
          ftPars(3), mzSqr(0.), ftBoundaryCondition(0)
          {}
    };
  ...
  public:
    ...
    double displayDrBarHiggsAccuracy() const { return drbarHiggsAccuracy; }
    double displayPhysHiggsAccuracy() const { return physHiggsAccuracy; }
  ...
  inline NmssmSoftsusy::NmssmSoftsusy()
    : NmssmSusyPars(), SoftParsNmssm(), MssmSoftsusy(), tSOVSMs(0.0),
      tSOVSMs1loop(0.0), drbarHiggsAccuracy(0.), physHiggsAccuracy(0.) {}
  ...
  inline NmssmSoftsusy::NmssmSoftsusy(const NmssmSusy &s)
    : NmssmSusyPars(s.displayNmssmSusy()), SoftParsNmssm(),
      ...
      tSOVSMs1loop(0.0), drbarHiggsAccuracy(0.),
      physHiggsAccuracy(0.) {
    setPars(121);
  }
