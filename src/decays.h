...
const double mcpole = 1.40; ///Change to alter quark "pole" masses used in h -> qq with QCD corrections
const double mspole = 0.19; ///Change to alter quark "pole" masses used in h -> qq with QCD corrections
