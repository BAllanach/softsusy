...
## Download
* <a id="raw-url" href="https://raw.githubusercontent.com/BAllanach/softsusy/master/tags/softsusy-4.1.21.tar.gz">SOFTSUSY-4.1.21</a> (07/08/23): bug-fixed neutralino_i -> chargino_i three-body decays: added missing CP-conjugate decay modes. Fixed naming of antiparticles and inos in comments of decay file to be more universal. Thanks to K Zhang for reporting the bug and finding the code location of it.
