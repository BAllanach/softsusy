...
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 3 tit "m_t=172.5+1" w l ls 2 lc 3

set output "multi4.eps"
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 4 tit "{/Symbol a}_s(M_Z)=0.1187-0.001" w l ls 2 lc 3

set output "multi5.eps"
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 5 tit "{/Symbol a}_s(M_Z)=0.1187+0.001" w l ls 2 lc 3
...
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 9 tit "A_0=-500 GeV" w l ls 2 lc 3

set output "multi10.eps"
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 10 tit "tan {/Symbol b}=40" w l ls 2 lc 3

set output "multi11.eps"
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 11 tit "M_{1/2}=200 GeV" w l ls 2 lc 3

set output "multi12.eps"
plot "cmssmScans" i 0 tit "default" w l, 1 notit w l ls 1 lc 2, \
"cmssmScans" i 12 tit "M_{1/2}=400 GeV" w l ls 2 lc 3
